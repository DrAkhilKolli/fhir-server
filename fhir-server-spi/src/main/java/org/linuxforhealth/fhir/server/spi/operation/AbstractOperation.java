                    ...
                    if (inputParameter.getPart() == null || inputParameter.getPart().isEmpty()) {
                        ...
                        try {
                            ...
                            if (ModelSupport.isResourceType(parameterDefinitionTypeName)) {
                                parameterDefinitionType = Class.forName("org.linuxforhealth.fhir.model.resource." + parameterDefinitionTypeName);
                            } else {
                                parameterDefinitionType = Class.forName("org.linuxforhealth.fhir.model.type." + parameterDefinitionTypeName);
                            }
