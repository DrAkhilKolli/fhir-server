...
import static org.linuxforhealth.fhir.config.FHIRConfiguration.PROPERTY_VALIDATION_FAIL_FAST;
...
import org.linuxforhealth.fhir.core.HTTPHandlingPreference;
...
import org.linuxforhealth.fhir.model.resource.Bundle.Entry.Search;
...
import org.linuxforhealth.fhir.persistence.context.impl.FHIRPersistenceContextImpl;
...
import org.linuxforhealth.fhir.server.rest.FHIRRestInteraction;
import org.linuxforhealth.fhir.server.rest.FHIRRestInteractionVisitorMeta;
import org.linuxforhealth.fhir.server.rest.FHIRRestInteractionVisitorOffload;
import org.linuxforhealth.fhir.server.rest.FHIRRestInteractionVisitorPersist;
import org.linuxforhealth.fhir.server.rest.FHIRRestInteractionVisitorReferenceMapping;
...
public class FHIRRestHelper implements FHIRResourceHelpers {
    ...
    private static final org.linuxforhealth.fhir.model.type.String SC_BAD_REQUEST_STRING = string(Integer.toString(SC_BAD_REQUEST));
    private static final org.linuxforhealth.fhir.model.type.String SC_ACCEPTED_STRING = string(Integer.toString(SC_ACCEPTED));
    ...
    public FHIRRestOperationResponse doCreateMeta(FHIRPersistenceEvent event, List<Issue> warnings, String type, Resource resource,
        ...
        try {
            ...
            final org.linuxforhealth.fhir.model.type.Instant lastUpdated = FHIRPersistenceSupport.getCurrentInstant();
    ...
    public FHIRRestOperationResponse doUpdateMeta(FHIRPersistenceEvent event, String type, String id, FHIRPatch patch, Resource newResource,
        ...
        try {
            ...
            final org.linuxforhealth.fhir.model.type.Instant lastUpdated = FHIRPersistenceSupport.getNewLastUpdatedInstant(currentLastUpdated);
            ...
            for (ResourceResult<? extends Resource> resourceResult : resourceResults) {
                ...
                if (resource != null) {
                    ...
                    Bundle.Entry.Response response = Bundle.Entry.Response.builder()
                            ...
                            .lastModified(org.linuxforhealth.fhir.model.type.Instant.of(resourceResult.getLastUpdated().atZone(UTC)))
                            .build();
    ...
    public void validateInteraction(Interaction interaction, String resourceType) throws FHIROperationException {
        ...
        org.linuxforhealth.fhir.config.Interaction configInteraction = org.linuxforhealth.fhir.config.Interaction.from(interaction.value());
    ...
    public Bundle doHistory(MultivaluedMap<String, String> queryParameters, String requestUri, String resourceType) throws Exception {
        ...
        for (int i=0; i<records.size(); i++) {
            ...
            responseBuilder.lastModified(org.linuxforhealth.fhir.model.type.Instant.of(changeRecord.getChangeTstamp().atZone(UTC)));
