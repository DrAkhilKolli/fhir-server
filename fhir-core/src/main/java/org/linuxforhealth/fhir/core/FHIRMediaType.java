...
public class FHIRMediaType extends MediaType {
    ...
    public static final Set<String> ADVERTISED_FHIR_VERSIONS =
            Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(VERSION_40, VERSION_43, VERSION_50)));
    public static final Set<String> SUPPORTED_FHIR_VERSIONS =
            Collections.unmodifiableSet(new LinkedHashSet<>(Arrays.asList(VERSION_40, VERSION_401, VERSION_43, VERSION_430, VERSION_50, VERSION_500)));
    ...
    private static final Map<String,String> fhirVersion50ParameterMap = Collections.singletonMap(FHIR_VERSION_PARAMETER, VERSION_50);
    ...
    public static final MediaType APPLICATION_FHIR_50_JSON_TYPE = new MediaType("application", SUBTYPE_FHIR_JSON, fhirVersion50ParameterMap);
    ...
    public static final MediaType APPLICATION_FHIR_40_XML_TYPE = new MediaType("application", SUBTYPE_FHIR_XML, fhirVersion40ParameterMap);
    public static final MediaType APPLICATION_FHIR_43_XML_TYPE = new MediaType("application", SUBTYPE_FHIR_XML, fhirVersion43ParameterMap);
    public static final MediaType APPLICATION_FHIR_50_XML_TYPE = new MediaType("application", SUBTYPE_FHIR_XML, fhirVersion50ParameterMap);
