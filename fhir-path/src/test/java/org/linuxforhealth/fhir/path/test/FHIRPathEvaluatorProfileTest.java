...
public class FHIRPathEvaluatorProfileTest {
    ...
    public static void main(String[] args) throws Exception {
        String specExample;
        try (BufferedReader reader = new BufferedReader(ExamplesUtil.resourceReader("json/spec/patient-examples-general.json"))) {
            specExample = reader.lines().collect(Collectors.joining(System.lineSeparator()));
        }
