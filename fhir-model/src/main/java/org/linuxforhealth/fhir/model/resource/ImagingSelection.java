...
import org.linuxforhealth.fhir.model.type.code.ImagingSelection2DGraphicType;
import org.linuxforhealth.fhir.model.type.code.ImagingSelection3DGraphicType;
import org.linuxforhealth.fhir.model.type.code.ImagingSelectionStatus;
...
public class ImagingSelection extends DomainResource {
    ...
    public static class Instance extends BackboneElement {
        ...
        public static class ImageRegion2D extends BackboneElement {
             ...
             *  The origin at the TLHC of the TLHC pixel is 0.0\0.0, the BRHC of the TLHC pixel is 1.0\1.0, and the BRHC of the BRHC 
             * pixel is the number of columns\rows in the image / frames. The values must be within the range 0\0 to the number of 
