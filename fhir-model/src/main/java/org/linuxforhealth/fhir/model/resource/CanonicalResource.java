...
public abstract class CanonicalResource extends DomainResource {
    ...
    protected final org.linuxforhealth.fhir.model.type.Element versionAlgorithm;
    @Summary
    ...
    public static abstract class Builder extends DomainResource.Builder {
        ...
        protected org.linuxforhealth.fhir.model.type.Element versionAlgorithm;
        ...
        protected List<ContactDetail> contact = new ArrayList<>();
        protected Markdown description;
        protected List<UsageContext> useContext = new ArrayList<>();
        protected List<CodeableConcept> jurisdiction = new ArrayList<>();
