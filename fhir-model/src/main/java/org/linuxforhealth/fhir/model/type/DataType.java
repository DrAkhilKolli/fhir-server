...
public abstract class DataType extends Element {
    ...
    public static abstract class Builder extends Element.Builder {
        ...
        protected void validate(DataType dataType) {
            super.validate(dataType);
        }

        protected Builder from(DataType dataType) {
            super.from(dataType);
            return this;
        }
    }
