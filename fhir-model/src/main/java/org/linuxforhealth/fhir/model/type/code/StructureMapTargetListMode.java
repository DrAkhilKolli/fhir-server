...
public class StructureMapTargetListMode extends Code {
     ...
     * single
     * 
     * <p>the target instance is shared with a number of target instances generated by another rule (up to the first common n 
     * items, then create new ones).
     */
    public static final StructureMapTargetListMode SINGLE = StructureMapTargetListMode.builder().value(Value.SINGLE).build();
