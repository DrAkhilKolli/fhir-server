...
import org.linuxforhealth.fhir.model.type.code.EligibilityOutcome;
...
public class CoverageEligibilityResponse extends DomainResource {
    ...
    @Summary
    @Binding(
        bindingName = "EligibilityOutcome",
        strength = BindingStrength.Value.REQUIRED,
        description = "The outcome of the processing.",
        valueSet = "http://hl7.org/fhir/ValueSet/eligibility-outcome|5.0.0"
    )
    @Required
    private final EligibilityOutcome outcome;
     ...
     * 
     * @return
     *     An immutable object of type {@link EligibilityOutcome} that is non-null.
     */
    ...
    public static class Builder extends DomainResource.Builder {
        ...
        protected void validate(CoverageEligibilityResponse coverageEligibilityResponse) {
            ...
            ValidationSupport.checkList(coverageEligibilityResponse.event, "event", Event.class);
        ...
        protected Builder from(CoverageEligibilityResponse coverageEligibilityResponse) {
            ...
            event.addAll(coverageEligibilityResponse.event);
    ...
    public static class Insurance extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             * 
             * @see #inforce(org.linuxforhealth.fhir.model.type.Boolean)
             */
        ...
        public static class Item extends BackboneElement {
            ...
            public static class Builder extends BackboneElement.Builder {
                 ...
                 *     A reference to this Builder instance
                 * 
                 * @see #authorizationRequired(org.linuxforhealth.fhir.model.type.Boolean)
                 */
