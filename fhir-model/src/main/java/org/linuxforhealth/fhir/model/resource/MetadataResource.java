...
public abstract class MetadataResource extends CanonicalResource {
    ...
    public static abstract class Builder extends CanonicalResource.Builder {
        ...
        protected List<CodeableConcept> topic = new ArrayList<>();
        protected List<ContactDetail> author = new ArrayList<>();
        protected List<ContactDetail> editor = new ArrayList<>();
        protected List<ContactDetail> reviewer = new ArrayList<>();
        protected List<ContactDetail> endorser = new ArrayList<>();
        protected List<RelatedArtifact> relatedArtifact = new ArrayList<>();
