...
public class BasisType extends Code {
    /**
     * Base
     * 
     * <p>Base Type: Base definition for all types defined in FHIR type system.
     */
    public static final BasisType BASE = BasisType.builder().value(Value.BASE).build();
     ...
     */
    public static final BasisType ELEMENT = BasisType.builder().value(Value.ELEMENT).build();
     ...
     * type.
     */
    public static final BasisType BACKBONE_ELEMENT = BasisType.builder().value(Value.BACKBONE_ELEMENT).build();
     ...
     */
    public static final BasisType DATA_TYPE = BasisType.builder().value(Value.DATA_TYPE).build();
     ...
     * <p>The ISO21090-codedString may be used to provide a coded representation of the contents of strings in an Address.
     */
    public static final BasisType ADDRESS = BasisType.builder().value(Value.ADDRESS).build();
     ...
     */
    public static final BasisType ANNOTATION = BasisType.builder().value(Value.ANNOTATION).build();
     ...
     */
    public static final BasisType ATTACHMENT = BasisType.builder().value(Value.ATTACHMENT).build();
     ...
     */
    public static final BasisType AVAILABILITY = BasisType.builder().value(Value.AVAILABILITY).build();
     ...
     */
    public static final BasisType BACKBONE_TYPE = BasisType.builder().value(Value.BACKBONE_TYPE).build();
     ...
     */
    public static final BasisType DOSAGE = BasisType.builder().value(Value.DOSAGE).build();
     ...
     */
    public static final BasisType ELEMENT_DEFINITION = BasisType.builder().value(Value.ELEMENT_DEFINITION).build();
     ...
     */
    public static final BasisType MARKETING_STATUS = BasisType.builder().value(Value.MARKETING_STATUS).build();
     ...
     */
    public static final BasisType PRODUCT_SHELF_LIFE = BasisType.builder().value(Value.PRODUCT_SHELF_LIFE).build();
     ...
     */
    public static final BasisType TIMING = BasisType.builder().value(Value.TIMING).build();
     ...
     * provided by text.
     */
    public static final BasisType CODEABLE_CONCEPT = BasisType.builder().value(Value.CODEABLE_CONCEPT).build();
     ...
     */
    public static final BasisType CODEABLE_REFERENCE = BasisType.builder().value(Value.CODEABLE_REFERENCE).build();
     ...
     */
    public static final BasisType CODING = BasisType.builder().value(Value.CODING).build();
     ...
     */
    public static final BasisType CONTACT_DETAIL = BasisType.builder().value(Value.CONTACT_DETAIL).build();
     ...
     */
    public static final BasisType CONTACT_POINT = BasisType.builder().value(Value.CONTACT_POINT).build();
     ...
     * endorsers.
     */
    public static final BasisType CONTRIBUTOR = BasisType.builder().value(Value.CONTRIBUTOR).build();
     ...
     */
    public static final BasisType DATA_REQUIREMENT = BasisType.builder().value(Value.DATA_REQUIREMENT).build();
     ...
     * used.
     */
    public static final BasisType EXPRESSION = BasisType.builder().value(Value.EXPRESSION).build();
     ...
     */
    public static final BasisType EXTENDED_CONTACT_DETAIL = BasisType.builder().value(Value.EXTENDED_CONTACT_DETAIL).build();
     ...
     */
    public static final BasisType EXTENSION = BasisType.builder().value(Value.EXTENSION).build();
     ...
     * information.
     */
    public static final BasisType HUMAN_NAME = BasisType.builder().value(Value.HUMAN_NAME).build();
     ...
     */
    public static final BasisType IDENTIFIER = BasisType.builder().value(Value.IDENTIFIER).build();
     ...
     */
    public static final BasisType META = BasisType.builder().value(Value.META).build();
     ...
     */
    public static final BasisType MONETARY_COMPONENT = BasisType.builder().value(Value.MONETARY_COMPONENT).build();
     ...
     */
    public static final BasisType MONEY = BasisType.builder().value(Value.MONEY).build();
     ...
     * for the resource.
     */
    public static final BasisType NARRATIVE = BasisType.builder().value(Value.NARRATIVE).build();
     ...
     */
    public static final BasisType PARAMETER_DEFINITION = BasisType.builder().value(Value.PARAMETER_DEFINITION).build();
     ...
     */
    public static final BasisType PERIOD = BasisType.builder().value(Value.PERIOD).build();
     ...
     */
    public static final BasisType PRIMITIVE_TYPE = BasisType.builder().value(Value.PRIMITIVE_TYPE).build();
     ...
     */
    public static final BasisType BASE64BINARY = BasisType.builder().value(Value.BASE64BINARY).build();
     ...
     */
    public static final BasisType BOOLEAN = BasisType.builder().value(Value.BOOLEAN).build();
     ...
     */
    public static final BasisType DATE = BasisType.builder().value(Value.DATE).build();
     ...
     */
    public static final BasisType DATE_TIME = BasisType.builder().value(Value.DATE_TIME).build();
     ...
     */
    public static final BasisType DECIMAL = BasisType.builder().value(Value.DECIMAL).build();
     ...
     */
    public static final BasisType INSTANT = BasisType.builder().value(Value.INSTANT).build();
     ...
     */
    public static final BasisType INTEGER = BasisType.builder().value(Value.INTEGER).build();
     ...
     */
    public static final BasisType POSITIVE_INT = BasisType.builder().value(Value.POSITIVE_INT).build();
     ...
     */
    public static final BasisType UNSIGNED_INT = BasisType.builder().value(Value.UNSIGNED_INT).build();
     ...
     */
    public static final BasisType INTEGER64 = BasisType.builder().value(Value.INTEGER64).build();
     ...
     */
    public static final BasisType STRING = BasisType.builder().value(Value.STRING).build();
     ...
     */
    public static final BasisType CODE = BasisType.builder().value(Value.CODE).build();
     ...
     * insensitive.
     */
    public static final BasisType ID = BasisType.builder().value(Value.ID).build();
     ...
     * presentation engine
     */
    public static final BasisType MARKDOWN = BasisType.builder().value(Value.MARKDOWN).build();
     ...
     */
    public static final BasisType TIME = BasisType.builder().value(Value.TIME).build();
     ...
     */
    public static final BasisType URI = BasisType.builder().value(Value.URI).build();
     ...
     */
    public static final BasisType CANONICAL = BasisType.builder().value(Value.CANONICAL).build();
     ...
     */
    public static final BasisType OID = BasisType.builder().value(Value.OID).build();
     ...
     */
    public static final BasisType URL = BasisType.builder().value(Value.URL).build();
     ...
     */
    public static final BasisType UUID = BasisType.builder().value(Value.UUID).build();
     ...
     */
    public static final BasisType QUANTITY = BasisType.builder().value(Value.QUANTITY).build();
     ...
     */
    public static final BasisType AGE = BasisType.builder().value(Value.AGE).build();
     ...
     */
    public static final BasisType COUNT = BasisType.builder().value(Value.COUNT).build();
     ...
     */
    public static final BasisType DISTANCE = BasisType.builder().value(Value.DISTANCE).build();
     ...
     */
    public static final BasisType DURATION = BasisType.builder().value(Value.DURATION).build();
     ...
     */
    public static final BasisType RANGE = BasisType.builder().value(Value.RANGE).build();
     ...
     */
    public static final BasisType RATIO = BasisType.builder().value(Value.RATIO).build();
     ...
     */
    public static final BasisType RATIO_RANGE = BasisType.builder().value(Value.RATIO_RANGE).build();
     ...
     */
    public static final BasisType REFERENCE = BasisType.builder().value(Value.REFERENCE).build();
     ...
     * references.
     */
    public static final BasisType RELATED_ARTIFACT = BasisType.builder().value(Value.RELATED_ARTIFACT).build();
     ...
     */
    public static final BasisType SAMPLED_DATA = BasisType.builder().value(Value.SAMPLED_DATA).build();
     ...
     * different utilities.
     */
    public static final BasisType SIGNATURE = BasisType.builder().value(Value.SIGNATURE).build();
     ...
     */
    public static final BasisType TRIGGER_DEFINITION = BasisType.builder().value(Value.TRIGGER_DEFINITION).build();
     ...
     */
    public static final BasisType USAGE_CONTEXT = BasisType.builder().value(Value.USAGE_CONTEXT).build();
     ...
     */
    public static final BasisType VIRTUAL_SERVICE_DETAIL = BasisType.builder().value(Value.VIRTUAL_SERVICE_DETAIL).build();
     ...
     */
    public static final BasisType XHTML = BasisType.builder().value(Value.XHTML).build();
     ...
     */
    public static final BasisType RESOURCE = BasisType.builder().value(Value.RESOURCE).build();
     ...
     */
    public static final BasisType BINARY = BasisType.builder().value(Value.BINARY).build();
     ...
     */
    public static final BasisType BUNDLE = BasisType.builder().value(Value.BUNDLE).build();
     ...
     */
    public static final BasisType DOMAIN_RESOURCE = BasisType.builder().value(Value.DOMAIN_RESOURCE).build();
     ...
     */
    public static final BasisType ACCOUNT = BasisType.builder().value(Value.ACCOUNT).build();
     ...
     */
    public static final BasisType ACTIVITY_DEFINITION = BasisType.builder().value(Value.ACTIVITY_DEFINITION).build();
     ...
     */
    public static final BasisType ACTOR_DEFINITION = BasisType.builder().value(Value.ACTOR_DEFINITION).build();
     ...
     */
    public static final BasisType ADMINISTRABLE_PRODUCT_DEFINITION = BasisType.builder().value(Value.ADMINISTRABLE_PRODUCT_DEFINITION).build();
     ...
     * constraints.
     */
    public static final BasisType ADVERSE_EVENT = BasisType.builder().value(Value.ADVERSE_EVENT).build();
     ...
     */
    public static final BasisType ALLERGY_INTOLERANCE = BasisType.builder().value(Value.ALLERGY_INTOLERANCE).build();
     ...
     */
    public static final BasisType APPOINTMENT = BasisType.builder().value(Value.APPOINTMENT).build();
     ...
     */
    public static final BasisType APPOINTMENT_RESPONSE = BasisType.builder().value(Value.APPOINTMENT_RESPONSE).build();
     ...
     */
    public static final BasisType ARTIFACT_ASSESSMENT = BasisType.builder().value(Value.ARTIFACT_ASSESSMENT).build();
     ...
     * analysis.
     */
    public static final BasisType AUDIT_EVENT = BasisType.builder().value(Value.AUDIT_EVENT).build();
     ...
     */
    public static final BasisType BASIC = BasisType.builder().value(Value.BASIC).build();
     ...
     */
    public static final BasisType BIOLOGICALLY_DERIVED_PRODUCT = BasisType.builder().value(Value.BIOLOGICALLY_DERIVED_PRODUCT).build();
     ...
     */
    public static final BasisType BIOLOGICALLY_DERIVED_PRODUCT_DISPENSE = BasisType.builder().value(Value.BIOLOGICALLY_DERIVED_PRODUCT_DISPENSE).build();
     ...
     */
    public static final BasisType BODY_STRUCTURE = BasisType.builder().value(Value.BODY_STRUCTURE).build();
     ...
     */
    public static final BasisType CANONICAL_RESOURCE = BasisType.builder().value(Value.CANONICAL_RESOURCE).build();
     ...
     */
    public static final BasisType CAPABILITY_STATEMENT = BasisType.builder().value(Value.CAPABILITY_STATEMENT).build();
     ...
     */
    public static final BasisType CARE_PLAN = BasisType.builder().value(Value.CARE_PLAN).build();
     ...
     * care.
     */
    public static final BasisType CARE_TEAM = BasisType.builder().value(Value.CARE_TEAM).build();
     ...
     * cost allocation.
     */
    public static final BasisType CHARGE_ITEM = BasisType.builder().value(Value.CHARGE_ITEM).build();
     ...
     */
    public static final BasisType CHARGE_ITEM_DEFINITION = BasisType.builder().value(Value.CHARGE_ITEM_DEFINITION).build();
     ...
     */
    public static final BasisType CITATION = BasisType.builder().value(Value.CITATION).build();
     ...
     */
    public static final BasisType CLAIM = BasisType.builder().value(Value.CLAIM).build();
     ...
     */
    public static final BasisType CLAIM_RESPONSE = BasisType.builder().value(Value.CLAIM_RESPONSE).build();
     ...
     * such as Apgar score.
     */
    public static final BasisType CLINICAL_IMPRESSION = BasisType.builder().value(Value.CLINICAL_IMPRESSION).build();
     ...
     */
    public static final BasisType CLINICAL_USE_DEFINITION = BasisType.builder().value(Value.CLINICAL_USE_DEFINITION).build();
     ...
     */
    public static final BasisType CODE_SYSTEM = BasisType.builder().value(Value.CODE_SYSTEM).build();
     ...
     */
    public static final BasisType COMMUNICATION = BasisType.builder().value(Value.COMMUNICATION).build();
     ...
     */
    public static final BasisType COMMUNICATION_REQUEST = BasisType.builder().value(Value.COMMUNICATION_REQUEST).build();
     ...
     */
    public static final BasisType COMPARTMENT_DEFINITION = BasisType.builder().value(Value.COMPARTMENT_DEFINITION).build();
     ...
     */
    public static final BasisType COMPOSITION = BasisType.builder().value(Value.COMPOSITION).build();
     ...
     */
    public static final BasisType CONCEPT_MAP = BasisType.builder().value(Value.CONCEPT_MAP).build();
     ...
     * level of concern.
     */
    public static final BasisType CONDITION = BasisType.builder().value(Value.CONDITION).build();
     ...
     */
    public static final BasisType CONDITION_DEFINITION = BasisType.builder().value(Value.CONDITION_DEFINITION).build();
     ...
     */
    public static final BasisType CONSENT = BasisType.builder().value(Value.CONSENT).build();
     ...
     */
    public static final BasisType CONTRACT = BasisType.builder().value(Value.CONTRACT).build();
     ...
     */
    public static final BasisType COVERAGE = BasisType.builder().value(Value.COVERAGE).build();
     ...
     */
    public static final BasisType COVERAGE_ELIGIBILITY_REQUEST = BasisType.builder().value(Value.COVERAGE_ELIGIBILITY_REQUEST).build();
     ...
     */
    public static final BasisType COVERAGE_ELIGIBILITY_RESPONSE = BasisType.builder().value(Value.COVERAGE_ELIGIBILITY_RESPONSE).build();
     ...
     * etc.
     */
    public static final BasisType DETECTED_ISSUE = BasisType.builder().value(Value.DETECTED_ISSUE).build();
     ...
     */
    public static final BasisType DEVICE = BasisType.builder().value(Value.DEVICE).build();
     ...
     */
    public static final BasisType DEVICE_ASSOCIATION = BasisType.builder().value(Value.DEVICE_ASSOCIATION).build();
     ...
     */
    public static final BasisType DEVICE_DEFINITION = BasisType.builder().value(Value.DEVICE_DEFINITION).build();
     ...
     */
    public static final BasisType DEVICE_DISPENSE = BasisType.builder().value(Value.DEVICE_DISPENSE).build();
     ...
     */
    public static final BasisType DEVICE_METRIC = BasisType.builder().value(Value.DEVICE_METRIC).build();
     ...
     */
    public static final BasisType DEVICE_REQUEST = BasisType.builder().value(Value.DEVICE_REQUEST).build();
     ...
     * clinician.
     */
    public static final BasisType DEVICE_USAGE = BasisType.builder().value(Value.DEVICE_USAGE).build();
     ...
     */
    public static final BasisType DIAGNOSTIC_REPORT = BasisType.builder().value(Value.DIAGNOSTIC_REPORT).build();

    /**
     * DocumentReference
     * 
     * <p>A reference to a document of any kind for any purpose. While the term “document” implies a more narrow focus, for 
     ...
     */
    public static final BasisType DOCUMENT_REFERENCE = BasisType.builder().value(Value.DOCUMENT_REFERENCE).build();
     ...
     */
    public static final BasisType ENCOUNTER = BasisType.builder().value(Value.ENCOUNTER).build();
     ...
     */
    public static final BasisType ENCOUNTER_HISTORY = BasisType.builder().value(Value.ENCOUNTER_HISTORY).build();
     ...
     * information.
     */
    public static final BasisType ENDPOINT = BasisType.builder().value(Value.ENDPOINT).build();
     ...
     */
    public static final BasisType ENROLLMENT_REQUEST = BasisType.builder().value(Value.ENROLLMENT_REQUEST).build();
     ...
     */
    public static final BasisType ENROLLMENT_RESPONSE = BasisType.builder().value(Value.ENROLLMENT_RESPONSE).build();
     ...
     */
    public static final BasisType EPISODE_OF_CARE = BasisType.builder().value(Value.EPISODE_OF_CARE).build();
     ...
     */
    public static final BasisType EVENT_DEFINITION = BasisType.builder().value(Value.EVENT_DEFINITION).build();
     ...
     */
    public static final BasisType EVIDENCE = BasisType.builder().value(Value.EVIDENCE).build();
     ...
     */
    public static final BasisType EVIDENCE_REPORT = BasisType.builder().value(Value.EVIDENCE_REPORT).build();
     ...
     */
    public static final BasisType EVIDENCE_VARIABLE = BasisType.builder().value(Value.EVIDENCE_VARIABLE).build();
     ...
     */
    public static final BasisType EXAMPLE_SCENARIO = BasisType.builder().value(Value.EXAMPLE_SCENARIO).build();
     ...
     */
    public static final BasisType EXPLANATION_OF_BENEFIT = BasisType.builder().value(Value.EXPLANATION_OF_BENEFIT).build();
     ...
     */
    public static final BasisType FAMILY_MEMBER_HISTORY = BasisType.builder().value(Value.FAMILY_MEMBER_HISTORY).build();
     ...
     */
    public static final BasisType FLAG = BasisType.builder().value(Value.FLAG).build();
     ...
     */
    public static final BasisType FORMULARY_ITEM = BasisType.builder().value(Value.FORMULARY_ITEM).build();
     ...
     */
    public static final BasisType GENOMIC_STUDY = BasisType.builder().value(Value.GENOMIC_STUDY).build();
     ...
     */
    public static final BasisType GOAL = BasisType.builder().value(Value.GOAL).build();
     ...
     */
    public static final BasisType GRAPH_DEFINITION = BasisType.builder().value(Value.GRAPH_DEFINITION).build();
     ...
     * Organization.
     */
    public static final BasisType GROUP = BasisType.builder().value(Value.GROUP).build();
     ...
     */
    public static final BasisType GUIDANCE_RESPONSE = BasisType.builder().value(Value.GUIDANCE_RESPONSE).build();
     ...
     * HealthcareServices.
     */
    public static final BasisType HEALTHCARE_SERVICE = BasisType.builder().value(Value.HEALTHCARE_SERVICE).build();
     ...
     */
    public static final BasisType IMAGING_SELECTION = BasisType.builder().value(Value.IMAGING_SELECTION).build();
     ...
     */
    public static final BasisType IMAGING_STUDY = BasisType.builder().value(Value.IMAGING_STUDY).build();
     ...
     */
    public static final BasisType IMMUNIZATION = BasisType.builder().value(Value.IMMUNIZATION).build();
     ...
     */
    public static final BasisType IMMUNIZATION_EVALUATION = BasisType.builder().value(Value.IMMUNIZATION_EVALUATION).build();
     ...
     */
    public static final BasisType IMMUNIZATION_RECOMMENDATION = BasisType.builder().value(Value.IMMUNIZATION_RECOMMENDATION).build();
     ...
     */
    public static final BasisType IMPLEMENTATION_GUIDE = BasisType.builder().value(Value.IMPLEMENTATION_GUIDE).build();
     ...
     */
    public static final BasisType INGREDIENT = BasisType.builder().value(Value.INGREDIENT).build();
     ...
     */
    public static final BasisType INSURANCE_PLAN = BasisType.builder().value(Value.INSURANCE_PLAN).build();
     ...
     */
    public static final BasisType INVENTORY_ITEM = BasisType.builder().value(Value.INVENTORY_ITEM).build();
     ...
     */
    public static final BasisType INVENTORY_REPORT = BasisType.builder().value(Value.INVENTORY_REPORT).build();
     ...
     * purpose.
     */
    public static final BasisType INVOICE = BasisType.builder().value(Value.INVOICE).build();
     ...
     */
    public static final BasisType LIBRARY = BasisType.builder().value(Value.LIBRARY).build();
     ...
     */
    public static final BasisType LINKAGE = BasisType.builder().value(Value.LINKAGE).build();
     ...
     */
    public static final BasisType LIST = BasisType.builder().value(Value.LIST).build();
     ...
     */
    public static final BasisType LOCATION = BasisType.builder().value(Value.LOCATION).build();
     ...
     */
    public static final BasisType MANUFACTURED_ITEM_DEFINITION = BasisType.builder().value(Value.MANUFACTURED_ITEM_DEFINITION).build();
     ...
     */
    public static final BasisType MEASURE = BasisType.builder().value(Value.MEASURE).build();
     ...
     */
    public static final BasisType MEASURE_REPORT = BasisType.builder().value(Value.MEASURE_REPORT).build();
     ...
     * medication use.
     */
    public static final BasisType MEDICATION = BasisType.builder().value(Value.MEDICATION).build();
     ...
     */
    public static final BasisType MEDICATION_ADMINISTRATION = BasisType.builder().value(Value.MEDICATION_ADMINISTRATION).build();
     ...
     */
    public static final BasisType MEDICATION_DISPENSE = BasisType.builder().value(Value.MEDICATION_DISPENSE).build();
     ...
     */
    public static final BasisType MEDICATION_KNOWLEDGE = BasisType.builder().value(Value.MEDICATION_KNOWLEDGE).build();
     ...
     * workflow patterns.
     */
    public static final BasisType MEDICATION_REQUEST = BasisType.builder().value(Value.MEDICATION_REQUEST).build();
     ...
     * 
     * <p>The primary difference between a medicationstatement and a medicationadministration is that the medication 
     ...
     */
    public static final BasisType MEDICATION_STATEMENT = BasisType.builder().value(Value.MEDICATION_STATEMENT).build();
     ...
     */
    public static final BasisType MEDICINAL_PRODUCT_DEFINITION = BasisType.builder().value(Value.MEDICINAL_PRODUCT_DEFINITION).build();
     ...
     */
    public static final BasisType MESSAGE_DEFINITION = BasisType.builder().value(Value.MESSAGE_DEFINITION).build();
     ...
     */
    public static final BasisType MESSAGE_HEADER = BasisType.builder().value(Value.MESSAGE_HEADER).build();
     ...
     * <p>Common Interface declaration for conformance and knowledge artifact resources.
     */
    public static final BasisType METADATA_RESOURCE = BasisType.builder().value(Value.METADATA_RESOURCE).build();
     ...
     */
    public static final BasisType MOLECULAR_SEQUENCE = BasisType.builder().value(Value.MOLECULAR_SEQUENCE).build();
     ...
     */
    public static final BasisType NAMING_SYSTEM = BasisType.builder().value(Value.NAMING_SYSTEM).build();
     ...
     */
    public static final BasisType NUTRITION_INTAKE = BasisType.builder().value(Value.NUTRITION_INTAKE).build();
     ...
     */
    public static final BasisType NUTRITION_ORDER = BasisType.builder().value(Value.NUTRITION_ORDER).build();
     ...
     */
    public static final BasisType NUTRITION_PRODUCT = BasisType.builder().value(Value.NUTRITION_PRODUCT).build();
     ...
     */
    public static final BasisType OBSERVATION = BasisType.builder().value(Value.OBSERVATION).build();
     ...
     * health care service.
     */
    public static final BasisType OBSERVATION_DEFINITION = BasisType.builder().value(Value.OBSERVATION_DEFINITION).build();
     ...
     * interaction).
     */
    public static final BasisType OPERATION_DEFINITION = BasisType.builder().value(Value.OPERATION_DEFINITION).build();
     ...
     */
    public static final BasisType OPERATION_OUTCOME = BasisType.builder().value(Value.OPERATION_OUTCOME).build();
     ...
     */
    public static final BasisType ORGANIZATION = BasisType.builder().value(Value.ORGANIZATION).build();
     ...
     */
    public static final BasisType ORGANIZATION_AFFILIATION = BasisType.builder().value(Value.ORGANIZATION_AFFILIATION).build();
     ...
     */
    public static final BasisType PACKAGED_PRODUCT_DEFINITION = BasisType.builder().value(Value.PACKAGED_PRODUCT_DEFINITION).build();
     ...
     * related services.
     */
    public static final BasisType PATIENT = BasisType.builder().value(Value.PATIENT).build();
     ...
     * resource references.
     */
    public static final BasisType PAYMENT_NOTICE = BasisType.builder().value(Value.PAYMENT_NOTICE).build();
     ...
     */
    public static final BasisType PAYMENT_RECONCILIATION = BasisType.builder().value(Value.PAYMENT_RECONCILIATION).build();
     ...
     */
    public static final BasisType PERMISSION = BasisType.builder().value(Value.PERMISSION).build();
     ...
     */
    public static final BasisType PERSON = BasisType.builder().value(Value.PERSON).build();
     ...
     */
    public static final BasisType PLAN_DEFINITION = BasisType.builder().value(Value.PLAN_DEFINITION).build();
     ...
     */
    public static final BasisType PRACTITIONER = BasisType.builder().value(Value.PRACTITIONER).build();
     ...
     */
    public static final BasisType PRACTITIONER_ROLE = BasisType.builder().value(Value.PRACTITIONER_ROLE).build();
     ...
     */
    public static final BasisType PROCEDURE = BasisType.builder().value(Value.PROCEDURE).build();
     ...
     * policies.
     */
    public static final BasisType PROVENANCE = BasisType.builder().value(Value.PROVENANCE).build();
     ...
     */
    public static final BasisType QUESTIONNAIRE = BasisType.builder().value(Value.QUESTIONNAIRE).build();
     ...
     */
    public static final BasisType QUESTIONNAIRE_RESPONSE = BasisType.builder().value(Value.QUESTIONNAIRE_RESPONSE).build();
     ...
     * Product.
     */
    public static final BasisType REGULATED_AUTHORIZATION = BasisType.builder().value(Value.REGULATED_AUTHORIZATION).build();
     ...
     */
    public static final BasisType RELATED_PERSON = BasisType.builder().value(Value.RELATED_PERSON).build();
     ...
     */
    public static final BasisType REQUEST_ORCHESTRATION = BasisType.builder().value(Value.REQUEST_ORCHESTRATION).build();
     ...
     * exchange, and that may have obligations associated with the role the actor plays.
     */
    public static final BasisType REQUIREMENTS = BasisType.builder().value(Value.REQUIREMENTS).build();
     ...
     */
    public static final BasisType RESEARCH_STUDY = BasisType.builder().value(Value.RESEARCH_STUDY).build();
     ...
     */
    public static final BasisType RESEARCH_SUBJECT = BasisType.builder().value(Value.RESEARCH_SUBJECT).build();
     ...
     */
    public static final BasisType RISK_ASSESSMENT = BasisType.builder().value(Value.RISK_ASSESSMENT).build();
     ...
     */
    public static final BasisType SCHEDULE = BasisType.builder().value(Value.SCHEDULE).build();
     ...
     */
    public static final BasisType SEARCH_PARAMETER = BasisType.builder().value(Value.SEARCH_PARAMETER).build();
     ...
     */
    public static final BasisType SERVICE_REQUEST = BasisType.builder().value(Value.SERVICE_REQUEST).build();
     ...
     */
    public static final BasisType SLOT = BasisType.builder().value(Value.SLOT).build();
     ...
     */
    public static final BasisType SPECIMEN = BasisType.builder().value(Value.SPECIMEN).build();
     ...
     */
    public static final BasisType SPECIMEN_DEFINITION = BasisType.builder().value(Value.SPECIMEN_DEFINITION).build();
     ...
     */
    public static final BasisType STRUCTURE_DEFINITION = BasisType.builder().value(Value.STRUCTURE_DEFINITION).build();
     ...
     */
    public static final BasisType STRUCTURE_MAP = BasisType.builder().value(Value.STRUCTURE_MAP).build();
     ...
     */
    public static final BasisType SUBSCRIPTION = BasisType.builder().value(Value.SUBSCRIPTION).build();
     ...
     */
    public static final BasisType SUBSCRIPTION_STATUS = BasisType.builder().value(Value.SUBSCRIPTION_STATUS).build();
     ...
     */
    public static final BasisType SUBSCRIPTION_TOPIC = BasisType.builder().value(Value.SUBSCRIPTION_TOPIC).build();
     ...
     */
    public static final BasisType SUBSTANCE = BasisType.builder().value(Value.SUBSTANCE).build();
     ...
     */
    public static final BasisType SUBSTANCE_DEFINITION = BasisType.builder().value(Value.SUBSTANCE_DEFINITION).build();
     ...
     */
    public static final BasisType SUBSTANCE_NUCLEIC_ACID = BasisType.builder().value(Value.SUBSTANCE_NUCLEIC_ACID).build();
     ...
     */
    public static final BasisType SUBSTANCE_POLYMER = BasisType.builder().value(Value.SUBSTANCE_POLYMER).build();
     ...
     */
    public static final BasisType SUBSTANCE_PROTEIN = BasisType.builder().value(Value.SUBSTANCE_PROTEIN).build();
     ...
     * <p>Todo.
     */
    public static final BasisType SUBSTANCE_REFERENCE_INFORMATION = BasisType.builder().value(Value.SUBSTANCE_REFERENCE_INFORMATION).build();
     ...
     */
    public static final BasisType SUBSTANCE_SOURCE_MATERIAL = BasisType.builder().value(Value.SUBSTANCE_SOURCE_MATERIAL).build();
     ...
     */
    public static final BasisType SUPPLY_DELIVERY = BasisType.builder().value(Value.SUPPLY_DELIVERY).build();
     ...
     */
    public static final BasisType SUPPLY_REQUEST = BasisType.builder().value(Value.SUPPLY_REQUEST).build();
     ...
     */
    public static final BasisType TASK = BasisType.builder().value(Value.TASK).build();
     ...
     */
    public static final BasisType TERMINOLOGY_CAPABILITIES = BasisType.builder().value(Value.TERMINOLOGY_CAPABILITIES).build();
     ...
     */
    public static final BasisType TEST_PLAN = BasisType.builder().value(Value.TEST_PLAN).build();
     ...
     */
    public static final BasisType TEST_REPORT = BasisType.builder().value(Value.TEST_REPORT).build();
     ...
     * specification.
     */
    public static final BasisType TEST_SCRIPT = BasisType.builder().value(Value.TEST_SCRIPT).build();
     ...
     */
    public static final BasisType TRANSPORT = BasisType.builder().value(Value.TRANSPORT).build();
     ...
     * (terminologies.html).
     */
    public static final BasisType VALUE_SET = BasisType.builder().value(Value.VALUE_SET).build();
     ...
     */
    public static final BasisType VERIFICATION_RESULT = BasisType.builder().value(Value.VERIFICATION_RESULT).build();
     ...
     */
    public static final BasisType VISION_PRESCRIPTION = BasisType.builder().value(Value.VISION_PRESCRIPTION).build();
     ...
     */
    public static final BasisType PARAMETERS = BasisType.builder().value(Value.PARAMETERS).build();

    private volatile int hashCode;

    private BasisType(Builder builder) {
        super(builder);
    }

    /**
     * Get the value of this BasisType as an enum constant.
     */
    ...
    /**
     * Factory method for creating BasisType objects from a passed enum value.
     */
    public static BasisType of(Value value) {
        switch (value) {
        case BASE:
            return BASE;
        case ELEMENT:
    ...
    /**
     * Factory method for creating BasisType objects from a passed string value.
     * 
     * @param value
     ...
     */
    public static BasisType of(java.lang.String value) {
        return of(Value.from(value));
    }

    /**
     * Inherited factory method for creating BasisType objects from a passed string value.
     * 
     * @param value
     *     A string that matches one of the allowed code values
     * @throws IllegalArgumentException
    ...
    public static class Builder extends Code.Builder {
         ...
         * 
         * @param value
         *     An enum constant for BasisType
         * 
         * @return
        ...
        @Override
        public BasisType build() {
            BasisType basisType = new BasisType(this);
            if (validating) {
                validate(basisType);
            }
            return basisType;
        ...
        protected void validate(BasisType basisType) {
            super.validate(basisType);
        }

        protected Builder from(BasisType basisType) {
            super.from(basisType);
            return this;
        }
    }
    ...
    public enum Value {
        ...
        /**
         * Factory method for creating BasisType.Value values from a passed string value.
         * 
         * @param value
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding BasisType.Value or null if a null value was passed
         * @throws IllegalArgumentException
