...
public class FHIRAllTypes extends Code {
     ...
     */
    public static final FHIRAllTypes BASE = FHIRAllTypes.builder().value(Value.BASE).build();
     ...
     */
    public static final FHIRAllTypes AVAILABILITY = FHIRAllTypes.builder().value(Value.AVAILABILITY).build();
     ...
     */
    public static final FHIRAllTypes BACKBONE_TYPE = FHIRAllTypes.builder().value(Value.BACKBONE_TYPE).build();
     ...
     */
    public static final FHIRAllTypes EXTENDED_CONTACT_DETAIL = FHIRAllTypes.builder().value(Value.EXTENDED_CONTACT_DETAIL).build();
     ...
     */
    public static final FHIRAllTypes MONETARY_COMPONENT = FHIRAllTypes.builder().value(Value.MONETARY_COMPONENT).build();
     ...
     */
    public static final FHIRAllTypes PRIMITIVE_TYPE = FHIRAllTypes.builder().value(Value.PRIMITIVE_TYPE).build();
     ...
     */
    public static final FHIRAllTypes INTEGER64 = FHIRAllTypes.builder().value(Value.INTEGER64).build();
     ...
     */
    public static final FHIRAllTypes VIRTUAL_SERVICE_DETAIL = FHIRAllTypes.builder().value(Value.VIRTUAL_SERVICE_DETAIL).build();
     ...
     */
    public static final FHIRAllTypes ACTOR_DEFINITION = FHIRAllTypes.builder().value(Value.ACTOR_DEFINITION).build();
     ...
     */
    public static final FHIRAllTypes ARTIFACT_ASSESSMENT = FHIRAllTypes.builder().value(Value.ARTIFACT_ASSESSMENT).build();
     ...
     */
    public static final FHIRAllTypes BIOLOGICALLY_DERIVED_PRODUCT_DISPENSE = FHIRAllTypes.builder().value(Value.BIOLOGICALLY_DERIVED_PRODUCT_DISPENSE).build();
     ...
     */
    public static final FHIRAllTypes CANONICAL_RESOURCE = FHIRAllTypes.builder().value(Value.CANONICAL_RESOURCE).build();
     ...
     */
    public static final FHIRAllTypes CONDITION_DEFINITION = FHIRAllTypes.builder().value(Value.CONDITION_DEFINITION).build();
     ...
     */
    public static final FHIRAllTypes DEVICE_ASSOCIATION = FHIRAllTypes.builder().value(Value.DEVICE_ASSOCIATION).build();
     ...
     */
    public static final FHIRAllTypes DEVICE_DISPENSE = FHIRAllTypes.builder().value(Value.DEVICE_DISPENSE).build();
     ...
     * clinician.
     */
    public static final FHIRAllTypes DEVICE_USAGE = FHIRAllTypes.builder().value(Value.DEVICE_USAGE).build();
     ...
     */
    public static final FHIRAllTypes ENCOUNTER_HISTORY = FHIRAllTypes.builder().value(Value.ENCOUNTER_HISTORY).build();
     ...
     */
    public static final FHIRAllTypes FORMULARY_ITEM = FHIRAllTypes.builder().value(Value.FORMULARY_ITEM).build();
     ...
     */
    public static final FHIRAllTypes GENOMIC_STUDY = FHIRAllTypes.builder().value(Value.GENOMIC_STUDY).build();
     ...
     */
    public static final FHIRAllTypes IMAGING_SELECTION = FHIRAllTypes.builder().value(Value.IMAGING_SELECTION).build();
     ...
     */
    public static final FHIRAllTypes INVENTORY_ITEM = FHIRAllTypes.builder().value(Value.INVENTORY_ITEM).build();
     ...
     */
    public static final FHIRAllTypes INVENTORY_REPORT = FHIRAllTypes.builder().value(Value.INVENTORY_REPORT).build();
     ...
     * <p>Common Interface declaration for conformance and knowledge artifact resources.
     */
    public static final FHIRAllTypes METADATA_RESOURCE = FHIRAllTypes.builder().value(Value.METADATA_RESOURCE).build();
     ...
     */
    public static final FHIRAllTypes NUTRITION_INTAKE = FHIRAllTypes.builder().value(Value.NUTRITION_INTAKE).build();
     ...
     */
    public static final FHIRAllTypes PERMISSION = FHIRAllTypes.builder().value(Value.PERMISSION).build();
     ...
     */
    public static final FHIRAllTypes REQUEST_ORCHESTRATION = FHIRAllTypes.builder().value(Value.REQUEST_ORCHESTRATION).build();
     ...
     * exchange, and that may have obligations associated with the role the actor plays.
     */
    public static final FHIRAllTypes REQUIREMENTS = FHIRAllTypes.builder().value(Value.REQUIREMENTS).build();
     ...
     */
    public static final FHIRAllTypes TEST_PLAN = FHIRAllTypes.builder().value(Value.TEST_PLAN).build();
     ...
     */
    public static final FHIRAllTypes TRANSPORT = FHIRAllTypes.builder().value(Value.TRANSPORT).build();
