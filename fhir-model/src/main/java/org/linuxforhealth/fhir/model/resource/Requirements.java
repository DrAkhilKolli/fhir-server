...
public class Requirements extends DomainResource {
    ...
    public static class Statement extends BackboneElement {
        ...
        private final List<Code> conformance;
         ...
         */
        public List<Code> getConformance() {
            return conformance;
        }
        ...
        public void accept(java.lang.String elementName, int elementIndex, Visitor visitor) {
            if (visitor.preVisit(this)) {
                ...
                if (visitor.visit(elementName, elementIndex, this)) {
                    ...
                    accept(conformance, "conformance", visitor, Code.class);
        ...
        public static class Builder extends BackboneElement.Builder {
            ...
            private List<Code> conformance = new ArrayList<>();
             ...
             *     A reference to this Builder instance
             */
            public Builder conformance(Code... conformance) {
                for (Code value : conformance) {
             ...
             *     If the passed collection is null
             */
            public Builder conformance(Collection<Code> conformance) {
            ...
            protected void validate(Statement statement) {
                ...
                ValidationSupport.checkList(statement.conformance, "conformance", Code.class);
