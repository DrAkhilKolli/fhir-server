...
public class BundleType extends Code {
     ...
     * 
     * <p>The bundle has been generated by a Subscription to communicate information to a client.
     */
    public static final BundleType SUBSCRIPTION_NOTIFICATION = BundleType.builder().value(Value.SUBSCRIPTION_NOTIFICATION).build();
