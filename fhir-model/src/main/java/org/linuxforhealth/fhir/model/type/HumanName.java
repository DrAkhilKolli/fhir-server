...
public class HumanName extends DataType {
    ...
    public static class Builder extends DataType.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #family(org.linuxforhealth.fhir.model.type.String)
         */
         ...
         *     A reference to this Builder instance
         * 
         * @see #given(org.linuxforhealth.fhir.model.type.String)
         */
         ...
         *     A reference to this Builder instance
         * 
         * @see #suffix(org.linuxforhealth.fhir.model.type.String)
         */
