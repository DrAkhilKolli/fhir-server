...
public abstract class PrimitiveType extends DataType {
    protected PrimitiveType(Builder builder) {
        super(builder);
    }
    ...
    public static abstract class Builder extends DataType.Builder {
        ...
        @Override
        public abstract PrimitiveType build();

        protected void validate(PrimitiveType primitiveType) {
            super.validate(primitiveType);
        }

        protected Builder from(PrimitiveType primitiveType) {
            super.from(primitiveType);
            return this;
        }
    }
}
