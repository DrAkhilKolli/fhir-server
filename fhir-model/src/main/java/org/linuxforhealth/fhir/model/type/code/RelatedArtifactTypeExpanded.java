...
public class RelatedArtifactTypeExpanded extends Code {
    /**
     * Documentation
     * 
     ...
     */
    public static final RelatedArtifactTypeExpanded DOCUMENTATION = RelatedArtifactTypeExpanded.builder().value(Value.DOCUMENTATION).build();
     ...
     * knowledge resource.
     */
    public static final RelatedArtifactTypeExpanded JUSTIFICATION = RelatedArtifactTypeExpanded.builder().value(Value.JUSTIFICATION).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded CITATION = RelatedArtifactTypeExpanded.builder().value(Value.CITATION).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded PREDECESSOR = RelatedArtifactTypeExpanded.builder().value(Value.PREDECESSOR).build();
     ...
     * independent of the status of each version.
     */
    public static final RelatedArtifactTypeExpanded SUCCESSOR = RelatedArtifactTypeExpanded.builder().value(Value.SUCCESSOR).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded DERIVED_FROM = RelatedArtifactTypeExpanded.builder().value(Value.DERIVED_FROM).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded DEPENDS_ON = RelatedArtifactTypeExpanded.builder().value(Value.DEPENDS_ON).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded COMPOSED_OF = RelatedArtifactTypeExpanded.builder().value(Value.COMPOSED_OF).build();
     ...
     * other artifacts).
     */
    public static final RelatedArtifactTypeExpanded PART_OF = RelatedArtifactTypeExpanded.builder().value(Value.PART_OF).build();
     ...
     * artifact.
     */
    public static final RelatedArtifactTypeExpanded AMENDS = RelatedArtifactTypeExpanded.builder().value(Value.AMENDS).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded AMENDED_WITH = RelatedArtifactTypeExpanded.builder().value(Value.AMENDED_WITH).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded APPENDS = RelatedArtifactTypeExpanded.builder().value(Value.APPENDS).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded APPENDED_WITH = RelatedArtifactTypeExpanded.builder().value(Value.APPENDED_WITH).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded CITES = RelatedArtifactTypeExpanded.builder().value(Value.CITES).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded CITED_BY = RelatedArtifactTypeExpanded.builder().value(Value.CITED_BY).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded COMMENTS_ON = RelatedArtifactTypeExpanded.builder().value(Value.COMMENTS_ON).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded COMMENT_IN = RelatedArtifactTypeExpanded.builder().value(Value.COMMENT_IN).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded CONTAINS = RelatedArtifactTypeExpanded.builder().value(Value.CONTAINS).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded CONTAINED_IN = RelatedArtifactTypeExpanded.builder().value(Value.CONTAINED_IN).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded CORRECTS = RelatedArtifactTypeExpanded.builder().value(Value.CORRECTS).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded CORRECTION_IN = RelatedArtifactTypeExpanded.builder().value(Value.CORRECTION_IN).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded REPLACES = RelatedArtifactTypeExpanded.builder().value(Value.REPLACES).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded REPLACED_WITH = RelatedArtifactTypeExpanded.builder().value(Value.REPLACED_WITH).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded RETRACTS = RelatedArtifactTypeExpanded.builder().value(Value.RETRACTS).build();
     ...
     * considered removed from publication and should no longer be considered part of the public record.
     */
    public static final RelatedArtifactTypeExpanded RETRACTED_BY = RelatedArtifactTypeExpanded.builder().value(Value.RETRACTED_BY).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded SIGNS = RelatedArtifactTypeExpanded.builder().value(Value.SIGNS).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded SIMILAR_TO = RelatedArtifactTypeExpanded.builder().value(Value.SIMILAR_TO).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded SUPPORTS = RelatedArtifactTypeExpanded.builder().value(Value.SUPPORTS).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded SUPPORTED_WITH = RelatedArtifactTypeExpanded.builder().value(Value.SUPPORTED_WITH).build();
     ...
     * relationship type.
     */
    public static final RelatedArtifactTypeExpanded TRANSFORMS = RelatedArtifactTypeExpanded.builder().value(Value.TRANSFORMS).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded TRANSFORMED_INTO = RelatedArtifactTypeExpanded.builder().value(Value.TRANSFORMED_INTO).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded TRANSFORMED_WITH = RelatedArtifactTypeExpanded.builder().value(Value.TRANSFORMED_WITH).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded DOCUMENTS = RelatedArtifactTypeExpanded.builder().value(Value.DOCUMENTS).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded SPECIFICATION_OF = RelatedArtifactTypeExpanded.builder().value(Value.SPECIFICATION_OF).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded CREATED_WITH = RelatedArtifactTypeExpanded.builder().value(Value.CREATED_WITH).build();
     ...
     */
    public static final RelatedArtifactTypeExpanded CITE_AS = RelatedArtifactTypeExpanded.builder().value(Value.CITE_AS).build();

    /**
     * Reprint
     * 
     * <p>A copy of the artifact in a publication with a different artifact identifier.
     */
    public static final RelatedArtifactTypeExpanded REPRINT = RelatedArtifactTypeExpanded.builder().value(Value.REPRINT).build();

    /**
     * Reprint Of
     * 
     * <p>The original version of record for which the current artifact is a copy.
     */
    public static final RelatedArtifactTypeExpanded REPRINT_OF = RelatedArtifactTypeExpanded.builder().value(Value.REPRINT_OF).build();

    private volatile int hashCode;

    private RelatedArtifactTypeExpanded(Builder builder) {
        super(builder);
    }

    /**
     * Get the value of this RelatedArtifactTypeExpanded as an enum constant.
     */
    ...
    /**
     * Factory method for creating RelatedArtifactTypeExpanded objects from a passed enum value.
     */
    public static RelatedArtifactTypeExpanded of(Value value) {
        switch (value) {
        case DOCUMENTATION:
    ...
    /**
     * Factory method for creating RelatedArtifactTypeExpanded objects from a passed string value.
     * 
     * @param value
     ...
     */
    public static RelatedArtifactTypeExpanded of(java.lang.String value) {
        return of(Value.from(value));
    }

    /**
     * Inherited factory method for creating RelatedArtifactTypeExpanded objects from a passed string value.
     * 
     * @param value
     *     A string that matches one of the allowed code values
     * @throws IllegalArgumentException
    ...
    public boolean equals(Object obj) {
        ...
        RelatedArtifactTypeExpanded other = (RelatedArtifactTypeExpanded) obj;
    ...
    public static class Builder extends Code.Builder {
         ...
         * 
         * @param value
         *     An enum constant for RelatedArtifactTypeExpanded
         * 
         * @return
        ...
        @Override
        public RelatedArtifactTypeExpanded build() {
            RelatedArtifactTypeExpanded relatedArtifactTypeExpanded = new RelatedArtifactTypeExpanded(this);
            if (validating) {
                validate(relatedArtifactTypeExpanded);
            }
            return relatedArtifactTypeExpanded;
        }

        protected void validate(RelatedArtifactTypeExpanded relatedArtifactTypeExpanded) {
            super.validate(relatedArtifactTypeExpanded);
        }

        protected Builder from(RelatedArtifactTypeExpanded relatedArtifactTypeExpanded) {
            super.from(relatedArtifactTypeExpanded);
            return this;
        }
    }
    ...
    public enum Value {
        ...
        /**
         * Factory method for creating RelatedArtifactTypeExpanded.Value values from a passed string value.
         * 
         * @param value
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding RelatedArtifactTypeExpanded.Value or null if a null value was passed
         * @throws IllegalArgumentException
