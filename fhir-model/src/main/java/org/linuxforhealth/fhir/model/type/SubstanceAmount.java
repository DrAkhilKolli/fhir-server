...
public class SubstanceAmount extends BackboneElement {
    ...
    @Summary
    private final Element referenceRange;
     ...
     */
    public Element getReferenceRange() {
    ...
    public static class Builder extends BackboneElement.Builder {
        ...
        private Element referenceRange;
         ...
         *     A reference to this Builder instance
         * 
         * @see #amountText(org.linuxforhealth.fhir.model.type.String)
         */
         ...
         *     A reference to this Builder instance
         */
        public Builder referenceRange(Element referenceRange) {
