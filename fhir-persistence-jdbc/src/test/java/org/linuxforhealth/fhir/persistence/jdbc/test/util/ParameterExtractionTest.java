...
public class ParameterExtractionTest {
    ...
    public void testBoolean() throws FHIRPersistenceProcessorException {
        ...
        org.linuxforhealth.fhir.model.type.Boolean.TRUE.accept(parameterBuilder);
        ...
        assertNullValueReturnsNoParameters(tokenSearchParam, org.linuxforhealth.fhir.model.type.Boolean.builder());
    }
    ...
    public void testString() throws FHIRPersistenceProcessorException {
        JDBCParameterBuildingVisitor parameterBuilder;
        org.linuxforhealth.fhir.model.type.String stringVal = string(SAMPLE_STRING);
        List<ExtractedParameterValue> params;
    ...
    public void testString_null() throws FHIRPersistenceProcessorException {
        assertNullValueReturnsNoParameters(stringSearchParam, org.linuxforhealth.fhir.model.type.String.builder());
        assertNullValueReturnsNoParameters(tokenSearchParam, org.linuxforhealth.fhir.model.type.String.builder());
    }
