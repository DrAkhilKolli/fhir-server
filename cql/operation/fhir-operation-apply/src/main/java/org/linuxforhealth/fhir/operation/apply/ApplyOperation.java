...
package org.linuxforhealth.fhir.operation.apply;
...
import org.linuxforhealth.fhir.model.resource.PlanDefinition.Action;
...
public class ApplyOperation extends AbstractOperation {
    ...
    private CodeableConcept internalCheckAndProcess(FHIROperationContext operationContext,
        ...
        for (Parameter p : parameters.getParameter()) {
            if (p.getName() != null && p.getName().getValue().compareTo(parameter) == 0) {
                return p.getValue().as(org.linuxforhealth.fhir.model.type.CodeableConcept.class);
            }
        }
        return null;
    }
    ...
    private String internalCheckAndProcess(FHIRResourceHelpers resourceHelper,
        ...
        if (result == null) {
            for (Parameter p : parameters.getParameter()) {
                ...
                if (p.getName() != null && p.getName().getValue().compareTo(parameter) == 0) {
                    result = p.getValue().as(org.linuxforhealth.fhir.model.type.String.class).getValue();
                    break;
                }
            }
        }
    ...
    private CarePlan transform(PlanDefinition planDefinition, List<String> subjects,
        ...
        if (userTaskContext != null) {
            builder.description(userTaskContext.as(org.linuxforhealth.fhir.model.type.String.class));
        }
        ...
        if (userLanguage != null) {
            org.linuxforhealth.fhir.model.type.String lang = userLanguage.getText();
