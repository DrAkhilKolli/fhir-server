...
public class AuditEventMapper implements Mapper {
    ...
    private static Map<String, org.linuxforhealth.fhir.model.type.code.AuditEventAction> buildMapToAction() {
        Map<String, org.linuxforhealth.fhir.model.type.code.AuditEventAction> map = new HashMap<>();
     ...
     */
    private org.linuxforhealth.fhir.model.type.Period period(AuditLogEntry entry) {
        // @formatter:off
        return org.linuxforhealth.fhir.model.type.Period.builder()
                .start(org.linuxforhealth.fhir.model.type.DateTime.of(
                    ZonedDateTime.of(Timestamp.valueOf(entry.getContext().getStartTime()).toLocalDateTime(), ZoneId.of("UTC"))
                    ))
                .end(org.linuxforhealth.fhir.model.type.DateTime.of(
