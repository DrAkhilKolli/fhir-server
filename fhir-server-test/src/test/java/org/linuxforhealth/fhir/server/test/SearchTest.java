...
import org.linuxforhealth.fhir.model.resource.Person.Link;
...
public class SearchTest extends FHIRServerTestBase {
    ...
    public void testCreateOrganization() throws Exception {
        ...
        organization = organization.toBuilder().name(org.linuxforhealth.fhir.model.type.String.of("test")).build();
    ...
    public void testCreatePatient() throws Exception {
        ...
        patient = patient.toBuilder()
                ...
                .managingOrganization(Reference.builder()
                    .reference(org.linuxforhealth.fhir.model.type.String.of("Organization/" + organizationId + "/_history/1"))
                    .build())
                .build();
    ...
    public void testCreatePractitionerRole() throws Exception {
        ...
        practitionerRole = practitionerRole.toBuilder()
                .organization(Reference.builder()
                    .reference(org.linuxforhealth.fhir.model.type.String.of("Organization/" + organizationId + "/_history/2"))
                    .build())
                .build();
